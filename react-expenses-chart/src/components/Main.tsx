...
const Main = () => {
    ...
    return (
        <main className="bg-card-white rounded-[.62rem] md:rounded-[1.25rem] py-[1.5rem] md:pt-[2rem]
                md:pb-[2.56rem] px-[1.25rem] md:px-[2.5rem]">
            <h2 className="text-[1.5rem] font-bold text-dark-brown md:text-[2rem]">
                Spending - Last 7 days
            </h2>

            <section className="mt-[3.25rem] flex justify-between items-end border-b-2 border-cream pb-[1.5rem] max-h-[13.62rem]">
